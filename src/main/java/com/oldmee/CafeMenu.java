...
public class CafeMenu extends Menu {
    ...
    public CafeMenu() {
        addItem("Coffer01", "(Fakin') Bacon with lettuce & tomato on whole wheat", true, 2.99);
        addItem("Coffer02", "Bacon with lettuce & tomato onwhole wheat", false, 2.99);
        addItem("Coffer03", "Soup of the day, with a side of potato salad", false, 3.29);
    }
